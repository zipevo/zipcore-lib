...
QuorumEntry.prototype.isValidQuorumSig = async function isValidQuorumSig() {
  if (this.isOutdatedRPC) {
    throw new Error(
      'Quorum cannot be verified: node running on outdated ZipCore version (< 0.16)'
    );
  }
...
QuorumEntry.prototype.getAllQuorumMembers = function getAllQuorumMembers(
  ...
  // See https://github.com/zippay/dips/blob/master/dip-0024.md#changes-to-the-initialization-phase
