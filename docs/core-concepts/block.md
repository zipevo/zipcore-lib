...
For detailed technical information about a block please visit [Blocks](https://zip-docs.github.io/en/glossary/block) on the Zip Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://zip-docs.github.io/en/developer-reference#block-headers) page on the Zip Developer Reference Wiki.
